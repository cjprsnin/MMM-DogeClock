Module.register("MMM-DogeClock", {
    ...
    fetchDebtData: async function() {
        try {
            ...
            const progressToGoal = (savings / 2_000_000_000_000) * 100; // % to $2T
        ...
        wrapper.innerHTML = `
            <div class="us-debt-container">
                <div class="us-debt">
                    ...
                    <div class="debt-amount">$${(debt / 1_000_000_000_000).toFixed(2)}T</div>
                </div>
                <div class="us-debt">
                ...
                <div class="us-debt">
                    ...
                    <div class="debt-amount">$${(savings / 1_000_000_000).toFixed(2)}B</div>
                </div>
            </div>
